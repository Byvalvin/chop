  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3
          className={`text-3xl sm:text-4xl font-extrabold ${titleColor} mb-8 sm:mb-12 text-center bg-clip-text bg-gradient-to-r from-[var(--secondary)] to-[var(--section-title-end-gradient)] relative flex justify-between items-center`}
        >
          ...
          <span className="absolute left-0 bottom-[-8px] w-full h-[4px] sm:h-[6px] bg-[var(--secondary-dark)] mt-6 sm:mt-8 rounded-full"></span>
        </h3>
        ...
        <div className="flex justify-end mt-6 sm:mt-8">
          <Link href={path} passHref>
            <button className="text-base sm:text-lg font-medium text-[var(--main-text)] border-2 border-[var(--secondary-dark)] bg-[var(--secondary-dark)] hover:bg-[var(--secondary)] hover:text-[var(--main-text)] transition-all py-2 px-5 sm:px-6 rounded-full shadow-lg hover:shadow-lg">
              See More
            </button>
          </Link>
        </div>
