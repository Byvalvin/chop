  ...
  return (
    <div
      className={`min-h-screen bg-[url('/images/bg/light1.png')] bg-cover bg-center bg-no-repeat ${
        isDark ? "bg-[var(--primary)]" : "bg-teal-100"
      }`}
    >
      <PageContainer>
        <div className="flex items-center justify-center px-4">
          <div
            className={`bg-opacity-90 backdrop-blur-sm border rounded-2xl shadow-lg hover:shadow-xl transition-shadow max-w-3xl py-16 px-6 ${
              isDark ? "bg-[var(--primary)] border-[var(--secondary-dark)] text-[var(--main-text)]" : "bg-[var(--main-text)] border-teal-100 text-[var(--other-text)]"
            }`}
          >
            {/* Title and Introductory Text */}
            <h1 className={`text-4xl font-bold ${isDark ? "text-[var(--secondary-light)]" : "text-[var(--secondary-dark)]"} mb-2`}>
              About Chop
            </h1>
            <p className={`text-md mb-8 ${isDark ? "text-[var(--sub-text)]" : "text-gray-500"}`}>
            ...
            <figure className="float-right ml-6 mb-8 rounded-xl overflow-hidden shadow w-1/3">
              ...
              />
              <figcaption
                className={`text-sm mt-2 italic text-center ${isDark ? "text-[var(--sub-text)]" : "text-gray-500"}`}
              >
            ...
            {/* Main Text */}
            <p className={`text-lg leading-relaxed mb-4 ${isDark ? "text-[var(--sub-text)]" : "text-gray-700"}`}>
            ...
            <blockquote
              className={`text-lg leading-relaxed italic border-l-4 pl-4 mt-8 mb-12 ${
                isDark ? "border-[var(--secondary-light)] text-[var(--sub-text)]" : "border-teal-300 text-gray-700"
              }`}
            >
            ...
            <div className="text-center mt-8">
              <Link
                href="/"
                className={`inline-block bg-[var(--secondary)] hover:bg-[var(--primary-cmpmt)] text-[var(--main-text)] font-semibold px-6 py-3 rounded-full transition ${
                  isDark ? "text-[var(--other-text)]" : "text-[var(--other-text)]"
                }`}
                title="Go back to the homepage"
              >
                I came for food
              </Link>
              <p className={`text-sm mt-2 ${isDark ? "text-[var(--sub-text)]" : "text-gray-500"}`}>← Back To Home</p>
            </div>
          </div>
        </div>
      </PageContainer>
