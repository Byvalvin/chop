        ...
        <div className="flex items-center justify-center px-4">
          <div
            className="bg-opacity-90 backdrop-blur-sm border rounded-2xl shadow-lg hover:shadow-xl transition-shadow max-w-3xl py-16 px-6 
              bg-[var(--primary)] border-[var(--secondary-dark)] text-[var(--main-text)]"
          >
            {/* Title and Introductory Text */}
            <h1 className="text-4xl font-bold text-[var(--secondary-light)] mb-2">
              About Chop
            </h1>
            <p className="text-md mb-8 text-[var(--sub-text)]">
            ...
            {/* Main Text */}
            <p className="text-lg leading-relaxed mb-4 text-[var(--sub-text)]">
            ...
            <blockquote
              className="text-lg leading-relaxed italic border-l-4 pl-4 mt-8 mb-12 border-[var(--secondary-light)] text-[var(--sub-text)]"
            >
